...
namespace
{
    bool isVersionMoreRecent(const QString &remoteVersion)
    {
        ...
        try
        {
            ...
            {
                const bool isDevVersion = QString {QLatin1String {QBT_VERSION_STATUS}}.contains(
...
{
    const QString RSS_URL {QLatin1String("https://www.fosshub.com/feed/5b8793a7f9ee5a5c3e97a3b2.xml")};
